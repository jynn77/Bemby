...
const zh = {
  ...
  accounts: {
    ...
    exportWarnBody: "此文件将包含 Telegram 会话令牌与 API Hash 等敏感凭据。请妥善保管，使用完毕后立即删除。",
    importTitle: "导入账户",
    importWarnBody: "导入文件包含 Telegram 会话令牌与 API Hash 等敏感凭据，请在导入完成后立即删除该文件。",
  ...
  settings: {
    ...
    appClientsHint: "自定义 Telegram 登录时的设备信息，不同账户可使用不同客户端环境。",
    appClientName: "名称",
...
const en: typeof zh = {
  ...
  accounts: {
    ...
    exportWarnBody: "This file will contain Telegram session tokens and API Hash credentials. Keep it secure and delete it immediately after use.",
    importTitle: "Import Accounts",
    importWarnBody: "This file contains Telegram session tokens and API credentials. Delete it immediately after importing.",
  ...
  settings: {
    ...
    appClientsHint: "Customise the device fingerprint Telegram sees per account to reduce the risk of bans.",
    appClientName: "Name",
